...
from logging import getLogger  # 用于日志记录

logger = getLogger(__name__)

def send_wechat_notification(message, title="森空岛自动签到任务"):
    """
    通过企业微信机器人发送通知消息
    
    Args:
        message (str): 要发送的消息内容
        title (str, optional): 消息标题，默认为"森空岛自动签到任务"
